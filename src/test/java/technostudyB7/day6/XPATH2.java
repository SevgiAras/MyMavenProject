...
9- Check if you see your products
   ...
   */
        ...
        product1.click();
        WebElement addChart =driver.findElement(By.xpath("//button[@name='add-to-cart-sauce-labs-backpack']"));
        addChart.click();
        ...
        product2.click();
        WebElement addChart2 =driver.findElement(By.xpath("//button[text()='Add to cart']"));
        addChart2.click();
